...
def parse_opts():
    ...
    parser.add_argument('--annotation_path', default='./cremad_preprocessing', type=str, help='Annotation file path')
    parser.add_argument('--result_path', default='./resultscrema', type=str, help='Result directory path')
    ...
    # parser.add_argument('--cremad_path', default='/home/yeskendir/RA/crema/crema-d-mirror',type=str,help='Root path to CREMA-D dataset')
    ...
    parser.set_defaults(only_inference=False)
    parser.add_argument("--media_path",type=str, default="",help="Path to input video/audio file")
    parser.add_argument('--model_path', type=str, default="",help="Path to best model.")
